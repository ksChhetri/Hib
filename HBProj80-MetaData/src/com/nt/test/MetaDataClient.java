...
public class MetaDataClient {
	public static void main(String args[]) {
		...
		EmpDetails eb = (EmpDetails) ses.get(EmpDetails.class, new Integer(102));
		...
		Type idType = persister.getIdentifierType();// should have been  getIdentifierTypes
		...
		System.out.println("\n Identifier type=" + idType.getName());
		System.out.println("\n Other columns are");
